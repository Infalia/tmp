            ...
            <div class="row">
                ...
                <div class="col l5">
                    <div class="social-linking">
                        ...
                        <a class="waves-effect waves-light btn light-blue darken-4">{{ $socialBtnFb }}</a>
                        <a class="waves-effect waves-light btn red">{{ $socialBtnGgl }}</a>
                        <a class="waves-effect waves-light btn red darken-4">{{ $socialBtnPint }}</a>
                        <a class="waves-effect waves-light btn light-blue darken-3">{{ $socialBtnLin }}</a>
                    </div>
                </div>
            </div>
